...
- **`apps/toymodule/`** — the single Django app holding all business logic:
  ...
  - `tests.py` — 153 tests covering currency conversion, the filters, the cart, checkout totals, who may read an order confirmation, and that no Django English leaks onto an Arabic page.
