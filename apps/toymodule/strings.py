...
STRINGS = {
    ...
    "navAges": ("Ages 3–10", "أعمار 3–10"),
    "navGifts": ("Gifts", "هدايا"),
    ...
    "promoBadge": ("Birthday box", "صندوق أعياد الميلاد"),
    "promoTitle1": ("Three surprise toys.", "ثلاث ألعاب مفاجئة."),
    "promoTitle2": ("One happy kid.", "طفل واحد سعيد."),
    "promoCta": ("Build a box", "جهّز صندوقًا"),
    # Split around the two prices the template interpolates.
    "promoBody1": ("Tell us their age and we'll pack a box worth", "أخبرنا بعمره ونجهّز صندوقًا قيمته"),
    "promoBody2": ("for", "بـ"),
    "promoBody3": ("Wrapped, with a hand-written card.", "مغلّف، ومعه بطاقة مكتوبة بخط اليد."),
